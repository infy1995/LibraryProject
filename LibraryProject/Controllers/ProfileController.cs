    ...
    public class ProfileController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var viewModel = new ProfileViewModel
            {
                ...
                Placed = db.Orders.Where(o=>o.OrderStatus == Order.OrderStatusEnum.Placed).ToList(),
                ...
                Returned = db.Orders.Where(o => o.OrderStatus == Order.OrderStatusEnum.Returned).ToList()
            };
