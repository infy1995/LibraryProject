    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    Profile czytelnik = new Profile { Login = model.Email };
                    LibraryContext db = new LibraryContext();
                    db.Profiles.Add(czytelnik);
                    db.SaveChanges();
                    ShoppingCart cart = new ShoppingCart();
                    cart.MigrateCart(model.Email);
                    ...
                    //MailSender.SendMail(user.Email, "Potwierdź konto", "Potwierdź konto, klikając <a href=\"" + callbackUrl + "\">tutaj</a>");
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                MailSender.SendMail(user.Id, "Resetuj hasło", "Resetuj hasło, klikając <a href=\"" + callbackUrl + "\">tutaj</a>");
